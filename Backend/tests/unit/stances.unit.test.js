  ...
  test("should return 200 OK with issue filter", () => {
    ...
    return request(app)
      ...
      .then((response) => {
        expect(response.statusCode).toBe(200);
        expect(response.body).toEqual(fakeStances);
        expect(db.getStancesFiltered).toHaveBeenCalledWith(null, 1, null);
      });
  });
  ...
  test("should return 200 OK with empty issue filter", () => {
    ...
    return request(app)
      ...
      .then((response) => {
        ...
        expect(db.getStancesFiltered).toHaveBeenCalledWith(null, 2, null);
      });
  });
  ...
  test("should return 200 OK with party filter", () => {
    ...
    return request(app)
      ...
      .then((response) => {
        ...
        expect(db.getStancesFiltered).toHaveBeenCalledWith(null, null, 1);
      });
  });
